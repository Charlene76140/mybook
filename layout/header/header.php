...
<head>
  <meta charset="utf-8">
  <title>MyBook</title>
  <meta name="description" content="MyBook est une application de gestion des livres dans une bibliothèque">
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bgColor">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php"><img src="logo.png" alt="logo MyBook"></a>
                ...
                <div class="collapse navbar-collapse textColor" id="navbarSupportedContent">
